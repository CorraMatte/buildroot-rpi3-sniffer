...
//static __u32 tst_flags = PCANFD_INIT_TS_DRV_REL;
//static __u32 tst_flags = PCANFD_INIT_TS_DEV_REL;
...
#endif
	l += sprintf(tmp+l, "%6u.%06u ",
			(uint )ptv->tv_sec, (uint )ptv->tv_usec);
			//tv_sec, tv_usec);
...
int main(int argc, char *argv[])
{
	...
	enum {
		...
		IN_DBITRATE, IN_DSAMPLE_PT,
		IN_CLOCK, IN_MAXLOOP, IN_ID, IN_PAUSE,
