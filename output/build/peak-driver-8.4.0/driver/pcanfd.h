...
/* defines how raw timestamps should be processed by the driver in the messages
 * it gives to the application */
#define PCANFD_INIT_TS_DRV_REL		0x00000000 /* rel. to driver init time*/
#define PCANFD_INIT_TS_DEV_REL		0x00000010 /* rel. to device init time*/
#define PCANFD_INIT_TS_HOST_REL		0x00000020 /* rel. to host init time */
